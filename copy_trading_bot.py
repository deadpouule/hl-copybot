...
class NadoQuantBot:
    def __init__(self):
        ...
        # VERIFIED PERP IDs: Loaded immediately so trading is active from second 1
        self.product_map = {
    ...
    async def sync_market_data(self):
        """Non-blocking background sync to update decimals/IDs."""
        while self.running:
            try:
    ...
    async def run(self):
        ...
        # START BACKGROUND TASKS - NO STARTUP BLOCK
