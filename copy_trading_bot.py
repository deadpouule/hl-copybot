...
RISK_POS_PCT = 0.10        # 10% of margin per trade (will use ~$11.80 for your $118 balance)
MIN_ORDER_USD = 11.0       
...
class NadoQuantBot:
    def __init__(self):
        logging.info("Initializing Final Rate-Limit Proof Nado Engine...")
        try:
    ...
    async def sync_nado_memory(self):
        while self.running:
            try:
                ...
                for c in to_clear:
                    logging.info(f"Manual Close Sync: Removing {c} from memory.")
    ...
    async def leaderboard_loop(self):
        while self.running:
            ...
            except Exception as e: logging.error(f"Leaderboard error: {e}")
